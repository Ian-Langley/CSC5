...
void savings(float [], int [], int[], int, float &, int);
...
int main(int argc, char** argv)
{
    ...
    float balance[nYears]; //Savings Balance $'s
...
void display(float balance[], int year[], int dYear[], int nYears, float intRate, float yrDep,float sav2Rtr)
{
    //Display the Heading
    float interest = balance[0] * intRate;
...
void savings(float balance[], int year[], int dYear[], int nYears, float &intRate, int yrDep)
{
    //Process or map Inputs to Outputs
    intRate /= CNVDCML;
